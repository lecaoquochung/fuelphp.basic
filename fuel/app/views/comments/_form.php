<?php 
	...
	“<form action="http://localhost/fuel_intro/public/index.php/comments/create" accept-charset="utf-8" method="post">” 
	so it’s a good idea to use these HTML elements when possible.*/
	echo Form::open(); 
?>
<p>
